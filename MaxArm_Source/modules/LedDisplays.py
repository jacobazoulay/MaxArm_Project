...
class LEDMatrixDisplay(TM1640):
    ...
    def display_flash(self, frame, num_flash=10, flash_speed=350):
        for i in range(num_flash):
            self.write(frame)
            time.sleep_ms((flash_speed * 3) // 4)
            self.update_display()
    ...
    def display_reader_result(self, result):
        ...
        results_map = {
            ...
            'waiting':      [0x1c, 0x60, 0x10, 0x60, 0x1c, 0x00, 0x7c, 0x14, 0x7c, 0x00, 0x7c, 0x00, 0x04, 0x7c, 0x04, 0x00],
            'no reading':   [0x7c, 0x04, 0x7c, 0x00, 0x7c, 0x44, 0x7c, 0x00, 0x7c, 0x04, 0x7c, 0x00, 0x7c, 0x54, 0x44, 0x00],
            'unrecognized': [0x00, 0x00, 0x7c, 0x54, 0x44, 0x00, 0x7c, 0x34, 0x5c, 0x00, 0x7c, 0x34, 0x5c, 0x00, 0x00, 0x00]
        }
        
        out = results_map.get(result, out)
        self.write(out)
